ATTACH TABLE _ UUID '19ebfcf1-1163-4881-ab90-954306eb631c'
(
    ...
    `auth_type` Nullable(Enum8('NO_PASSWORD' = 0, 'PLAINTEXT_PASSWORD' = 1, 'SHA256_PASSWORD' = 2, 'DOUBLE_SHA1_PASSWORD' = 3, 'LDAP' = 4, 'KERBEROS' = 5, 'SSL_CERTIFICATE' = 6)),
    `profiles` Array(LowCardinality(String)),
    `roles` Array(LowCardinality(String)),
    `settings` Array(Tuple(LowCardinality(String), String)),
    `client_address` IPv6,
    `client_port` UInt16,
    `interface` Enum8('TCP' = 1, 'HTTP' = 2, 'gRPC' = 3, 'MySQL' = 4, 'PostgreSQL' = 5, 'Local' = 6, 'TCP_Interserver' = 7),
